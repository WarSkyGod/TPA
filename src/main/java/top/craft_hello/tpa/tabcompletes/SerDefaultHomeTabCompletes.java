...
public class SerDefaultHomeTabCompletes implements TabCompleter {
        ...
        if (sender instanceof Player){
            ...
            for (String homeName : homeSet) {
                if (homeName.contains("homes.")) {
                    ...
                    if (!homeName2.contains(".") && !homeName2.equals(playerData.getString("default_home"))) list.add(homeName2);
                }
            }
